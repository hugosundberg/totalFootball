const TeamStats = ({ seasonStats }: TeamStats) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full bg-black text-sm sm:text-base">
      <div className="flex flex-col w-full h-full bg-zinc-900 pt-4 sm:rounded-2xl overflow-hidden">
        ...
        <div>
          <div className="grid grid-cols-[2fr_1fr_1fr_1fr] px-6 py-3 gap-4 col-span-4 bg-zinc-700 border-solid border-b-[1.5px] border-t-[1.5px] border-zinc-500">
            <p className="col-start-2">Home</p>
            <p>Away</p>
            <p>Total</p>
          </div>

          <div className="grid grid-cols-[2fr_1fr_1fr_1fr] px-6 py-3 gap-4 col-span-4 bg-zinc-800 border-solid border-b-[1.5px] border-zinc-500">
            <p>Games played</p>
          ...
          <p className="grid grid-cols-[2fr_1fr_1fr_1fr] px-6 py-3 gap-4 col-span-4 bg-zinc-700 border-solid border-b-[1.5px] border-zinc-500">
            GOALS
          </p>
          ...
          <div className="grid grid-cols-[2fr_1fr_1fr_1fr] px-6 py-3 gap-4 col-span-4 bg-zinc-800 border-solid  border-zinc-500">
            <p>Goals average</p>
