  ...
  return (
    <div className="body flex relative pt-10 px-4 top-10 z-0 h-screen bg-slate-100 dark:bg-black w-full justify-center">
      <div className="content flex w-screen bg-slate-100 dark:bg-black max-w-screen-xl">
        <div className="league-container hidden md:md:flex flex-col left-0 text-white bg-white dark:bg-zinc-900 w-60 h-fit rounded-2xl overflow-hidden">
        ...
        <div className="hidden md:lg:flex gap-4 h-fit ml-4 bg-white dark:text-white dark:bg-zinc-900 w-1/4 rounded-2xl flex-col overflow-hidden">
