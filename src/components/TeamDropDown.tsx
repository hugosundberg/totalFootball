...
const TeamDropDown = ({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left w-full mb-4">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-zinc-800 px-3 py-2 text-sm font-semibold text-white  shadow-xs ring-gray-300 ring-inset hover:bg-zinc-500">
      ...
      <MenuItems
        transition
        className="absolute z-10 mt-2 w-full origin-top-right rounded-md dark:bg-zinc-800 dark:text-white ring-1 shadow-lg ring-black/5 transition focus:outline-hidden data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
      >
            ...
            <MenuItem key={competition.competitions.league.id}>
              ...
              >
                <img
                  ...
                  alt=""
                  className="h-10 w-10 object-contain bg-white p-2 rounded-full"
                />
